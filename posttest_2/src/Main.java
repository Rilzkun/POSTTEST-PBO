...
public class Main {
    public static void main(String[] args) {
            ...
            if (pilihan == 1) {
                ...
                if (listMember.isEmpty()) {
                    ...
                    for (int i = 0; i < listMember.size(); i++) {
                        System.out.println((i + 1) + ". " + listMember.get(i).getNama() + 
                                           " (" + listMember.get(i).getPaket() + ")");
                    }
                }
                ...
                if (index >= 0 && index < listMember.size()) {
                    ...
                    System.out.print("Update Paket: "); 
                    String paketBaru = input.nextLine();
                
                    listMember.get(index).setNama(namaBaru);
                    listMember.get(index).setPaket(paketBaru);
        ...
        input.close();
        System.out.println("Terima kasih, Rangga. Semangat kuliahnya!");
    }
}